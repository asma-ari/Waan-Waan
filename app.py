...
- ปฏิทิน FullCalendar เด้ง Popup Dialog พิมพ์/ลบบันทึกไดอารี่
- จัดการกิจกรรมวนซ้ำ: เพิ่ม, แก้ไข (Edit Dialog), และ ลบ กิจกรรมได้
"""
...
# -------------------------------------------------------------
# 🪟 POPUP DIALOG 1: เด้งขึ้นมากลางจอเมื่อคลิกเลือกวันที่ในปฏิทิน
# -------------------------------------------------------------
...
# -------------------------------------------------------------
# 🪟 POPUP DIALOG 2: หน้าต่างแก้ไขกิจกรรมวนซ้ำ
# -------------------------------------------------------------
...
with tab_habits:
    ...
    for h in habits:
        ...
        with col2:
            # ปุ่มแก้ไขกิจกรรม
            if st.button("✏️ แก้ไข", key=f"edit_h_{h['id']}"):
                open_edit_habit_dialog(h)
        with col3:
            # ปุ่มลบกิจกรรม
            if st.button("🗑️ ลบ", key=f"del_h_{h['id']}"):
